...
public class TestMetod extends MainTest {
 ...
 //  public void chekingSubjectsContainer(String Subjects){     /*Проверка не функционирует т.к. в данном поле не сохраняется результат ввода */
 //      subjectsContainer.setValue(Subjects);
 //      subjectsContainer.sendKeys("Enter");
 //  }
